...
function header(){
    ...
    <nav class="navbar navo navbar-expand-lg bg-blue">
            ...
            <div class="collapse navbar-collapse" dir="ltr" id="navbarSupportedContent">
                <ul class="navbar-nav me-3 mb-2 mb-lg-0 h6">
                    ...
                    <li class="nav-item">
                        <a class="nav-link links-settings" href="#js">javaScript</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link links-settings" href="#pythonProjects">Python</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link links-settings" href="#contact">ContactUs</a>
                    </li>
                </ul>
            </div>
        </nav>
